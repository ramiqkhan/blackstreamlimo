      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        ...
        <div className="hidden md:grid grid-cols-3 items-center w-full">
          ...
          <div className="flex justify-center">
            <a href="#" className="text-xl lg:text-2xl font-sans font-semibold tracking-[0.25em] text-zinc-900 dark:text-white hover:opacity-90 transition-opacity whitespace-nowrap">
          ...
          <div className="flex items-center justify-end gap-4">
            {/* Secondary navigation links that didn't fit on the left side to keep it balanced */}
        ...
        <div className="flex md:hidden justify-between items-center w-full">
          ...
          {/* Mobile Center: Logo */}
          <a href="#" className="text-lg font-sans font-semibold tracking-[0.2em] text-zinc-900 dark:text-white">
            BLACK<span className="text-[#cda250] font-light">STREAM</span>
          </a>
